...
export function WithdrawFlutterwaveModal({ balance, onClose, onSuccess }) {
        ...
        <div className="fixed inset-0 backdrop-blur-md bg-black/20 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg w-full max-w-md max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-center border-b p-4 sticky top-0 bg-white">
                    <h3 className="text-lg font-semibold">Withdraw from Flutterwave Balance</h3>
                ...
                <div className="p-4">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex justify-end space-x-3 pt-4 border-t">
                            ...
                            <button
                                type="submit"
                                className="px-6 py-3 bg-destructive text-white rounded-lg hover:bg-destructive/90 disabled:bg-destructive/50 transition-colors font-medium flex items-center"
