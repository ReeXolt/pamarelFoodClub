...
import { useCartStore, getCartCount, getCartTotal, type CartItem } from "@/stores/cart-store";
...
function VariantBadges({ item }: { item: CartItem }) {
...
function ItemPrice({ item }: { item: CartItem }) {
