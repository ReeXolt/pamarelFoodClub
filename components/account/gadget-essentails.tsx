...
export function GadgetEssentails() {
	...
	const fetchGadgetEssentials = async (): Promise<void> => {
		try {
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-12">
						...
						<p className="text-gray-600 mt-4">
							Must-have tech for modern living
						</p>
					</div>
						...
						return (
							...
							>
								...
								<div className="p-4 grid gap-2">
									<h3 className="font-semibold text-sm text-gray-900 group-hover:text-yellow-600 transition-colors line-clamp-2">
										{product.name}
									</h3>
